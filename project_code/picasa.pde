...
String getRandomPicasaUrl(String _searchWord) {
  ...
  try {
    ...
    baseSearchUrl = new URL("https://picasaweb.google.com/data/feed/api/featured?feat=featured_all");
  } 
  catch (Exception e) {
  ...
  // search parameters
  //myQuery.setFullTextQuery(_searchWord);
